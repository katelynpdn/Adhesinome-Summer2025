...
# Extract sequences satisfying all 3 conditions and satisfying at least 1 condition into ../results/seqList_all and ../results/seqList_other
python extractSeq.py proteinTable.csv "$proteomeFile"
