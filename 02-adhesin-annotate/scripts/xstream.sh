...
# Modified by Katelyn Nguyen 06-26-25: Change path to xstream.jar and sub.txt; Make output directory
java -Xmx1000m -Xms1000m -jar ../xstream/xstream.jar $in -i.7 -I.7 -g3 -e2 -L15 -z -A../xstream/sub.txt -B -O -a$name
