...
# CHANGE ID HERE, to modify input&output directory
uniprotID = "positive_adhesin"

# Input and output directory
params <- list(args = paste0("/Users/katelynnguyen/Downloads/Adhesinome-Summer2025/02-adhesin-annotate/results/", uniprotID, "_output"))
...
```
Graph Venn Diagram of Part 1 output
```{r graphVennDiagram}
part_one_df %>% 
